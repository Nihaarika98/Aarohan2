...
import aarohan.nihaarika.aarohan.AArohan.Splash_Screen;
...
public class Events_IN_MBA extends Fragment {
    CardView aarohan,past_Events,current_Events,exal;
    Activity activity;
    ...
    public void onStart() {
        ...
        past_Events = activity.findViewById(R.id.past_event);
